...
import { Github, Globe, Infinity as InfinityIcon, Linkedin, Mail, Twitter } from "lucide-react";
            ...
            <SiteContainer className="space-y-10">
                    ...
                    <div className="site-panel p-8">
                        ...
                        <div className="mt-6 flex gap-3">
                            {[Github, Twitter, Linkedin].map((Icon, index) => (
                                <a key={index} href="#" className="site-outline-card flex h-11 w-11 items-center justify-center">
                ...
                <div className="flex flex-col items-start justify-between gap-4 text-sm text-muted-foreground md:flex-row md:items-center">
                    <div className="flex items-center gap-2">
                        <span>© {new Date().getFullYear()} MathSphere.</span>
                        <InfinityIcon className="h-4 w-4 text-[var(--accent)]" />
                        <span>Precision, structure, continuity.</span>
                    </div>
