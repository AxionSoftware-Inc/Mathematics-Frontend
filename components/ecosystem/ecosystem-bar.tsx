  ...
  return (
    <div className="border-b border-[#e7e9ee] bg-[#f7f8fa] text-[#606875]">
      <div className="mx-auto flex h-9 w-full max-w-[1720px] items-center justify-between gap-3 px-4 sm:px-6">
        <a href={getEcosystemHref("science", currentApp, activeProjectId)} className="shrink-0 text-[11px] font-semibold tracking-[0.08em] text-[#111827]">
          {ECOSYSTEM_NAME}
        </a>
        ...
        <div className="hidden min-w-0 max-w-[260px] items-center gap-2 text-[11px] sm:flex">
          ...
          <span className="truncate font-medium text-[#303640]">{activeProjectTitle || (activeProjectId ? "Active project" : "Local workspace")}</span>
        </div>
      </div>
    </div>
  );
